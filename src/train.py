...
def setup_training_loop_kwargs(
    ...
    if cfg == 'auto':
        ...
        spec.r1_gamma = 0.0004 * (res ** 2) / spec.mb # heuristic formula
        spec.ema = spec.mb * 10 / 32

    args.G_kwargs = dnnlib.EasyDict(class_name='training.networks.Generator', z_dim=512, w_dim=512, mapping_kwargs=dnnlib.EasyDict(), synthesis_kwargs=dnnlib.EasyDict())
    args.D_kwargs = dnnlib.EasyDict(class_name='training.networks.OurDiscriminator', block_kwargs=dnnlib.EasyDict(), mapping_kwargs=dnnlib.EasyDict(), epilogue_kwargs=dnnlib.EasyDict())
    ...
    args.loss_kwargs = dnnlib.EasyDict(class_name='training.loss.OurStyleGAN2Loss', r1_gamma=spec.r1_gamma)
    ...
    if aug != 'noaug' and aug != 'diffaugment':
